      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              <h4>Online lecture Notes</h4>
              <p>Whenever, Where ever you need Notes can get here.</p>
              <div class="main-button">
                <a href="#">Read More</a>
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              <h4>Online lecture Video</h4>
              <p>You can watch your lecture video's here. </p>
              <div class="main-button">
                <a href="#">Read More</a>
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              ...
              <p>Ask your study related doubt to our online teachers.</p>
              <div class="main-button">
                <a href="#">Read More</a>
              </div>
            </div>
